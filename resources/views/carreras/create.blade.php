    ...
    <div class="card-body">
        ...
        <form action="{{ route('carreras.store') }}" method="POST" id="formCarrera">
            ...
            <div class="form-group" id="div_nombre">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ej: Computación e Informática, 5to Año Secundaria">
            ...
            <div class="form-group" id="div_otros" style="display: none;">
                ...
                <input type="text" id="nombre_otros" name="nombre_otros" class="form-control" placeholder="Ej: Personal Administrativo, Docente, Visitante">
            ...
            <div class="form-group" id="div_acronimo" style="display: none;">
                ...
                <input type="text" id="acronimo" name="acronimo" class="form-control" placeholder="Ej: SI, AD, CF, ENF" maxlength="10">
                <small class="form-text text-muted">
            ...
            <div id="info_escuela" style="display: none;">
                <div class="alert alert-success">
                    ...
                    <strong>Escuela:</strong> Estás creando un grado/nivel educativo. No necesitas ingresar acrónimo.
...
function actualizarCampos() {
    ...
    document.getElementById('nombre_otros').value = '';
